!
  ...
  Date formatter utility library that allows formatting datetime variables or Date objects using PHP DateTime format.
  @see httpphp.netmanualenfunction.date.php
 
  For more JQuery plugins visit httpplugins.krajee.com
  For more Yii related demos visit httpdemos.krajee.com
...
(function () {
    ...
    defaultSettings = {
        ...
        tzParts b([PMCEA][SDP]T(PacificMountainCentralEasternAtlantic) (StandardDaylightPrevailing) Time(GMTUTC)([-+]d{4}))bg,
        tzClip [^-+dA-Z]g
    };
            ...
            fmt = {
                ...
                u function () {
                 ...
                 TIMEZONE 
                  ...
                  Timezone identifier `e.g. AtlanticAzores, ...`
                  @return {string}
                ...
                O function () {
                  ...
                  Difference to GMT with colon `e.g. +0200`
                  @return {string}
                ...
                c function () {
                    return 'Y-m-dTHisP'.replace(backspace, doFormat);
                },
                ...
                r function () {
                    return 'D, d M Y His O'.replace(backspace, doFormat);
                },
  ...
  @homepage httpxdsoft.netjqpluginsdatetimepicker
...
;(function (factory) {
	...
	var default_options  = {
		...
		startDate	false,  new Date(), '19861208', '-19700105','-19700105',
		step 60,
		...
		defaultTime false,	 use formatTime format (ex. '1000' for formatTime	'Hi')
		defaultDate false,	 use formatDate format (ex new Date() or '19861208' or '-19700105' or '-19700105')
	...
	$.datetimepicker = {
		setLocale function(locale){
			var newLocale = default_options.i18n[locale]localeglobalLocaleDefault;
		...
		RFC_2822 'D, d M Y His O',
		ATOM 'Y-m-dTHisP',
		ISO_8601 'Y-m-dTHisO',
		RFC_822 'D, d M y His O',
		RFC_850 'l, d-M-y His T',
		RFC_1036 'D, d M y His O',
		RFC_1123 'D, d M Y His O',
		RSS 'D, d M Y His O',
		W3C 'Y-m-dTHisP'
	};
	...
	$.fn.xdsoftScroller = function (percent) {
		return this.each(function () {
			...
			if (!$(this).hasClass('xdsoft_scroller_box')) {
				...
				scrollbar = $('div class=xdsoft_scrollbardiv');
				scroller = $('div class=xdsoft_scrollerdiv');
	...
	$.fn.datetimepicker = function (opt, opt2) {
		...
		createDateTimePicker = function (input) {
			var datetimepicker = $('div class=xdsoft_datetimepicker xdsoft_noselectdiv'),
				xdsoft_copyright = $('div class=xdsoft_copyrighta target=_blank href=httpxdsoft.netjqpluginsdatetimepickerxdsoft.netadiv'),
				datepicker = $('div class=xdsoft_datepicker activediv'),
				mounth_picker = $('div class=xdsoft_mounthpickerbutton type=button class=xdsoft_prevbuttonbutton type=button class=xdsoft_today_buttonbutton' +
					'div class=xdsoft_label xdsoft_monthspanspaniidiv' +
					'div class=xdsoft_label xdsoft_yearspanspaniidiv' +
					'button type=button class=xdsoft_nextbuttondiv'),
				calendar = $('div class=xdsoft_calendardiv'),
				timepicker = $('div class=xdsoft_timepicker activebutton type=button class=xdsoft_prevbuttondiv class=xdsoft_time_boxdivbutton type=button class=xdsoft_nextbuttondiv'),
				timeboxparent = timepicker.find('.xdsoft_time_box').eq(0),
				timebox = $('div class=xdsoft_time_variantdiv'),
                applyButton = $('button type=button class=xdsoft_save_selected blue-gradient-buttonSave Selectedbutton'),

				monthselect = $('div class=xdsoft_select xdsoft_monthselectdivdivdiv'),
				yearselect = $('div class=xdsoft_select xdsoft_yearselectdivdivdiv'),
						...
						.on('blur.xdsoft', function () {
							if (options.allowBlank && (!$.trim($(this).val()).length  $.trim($(this).val()) === options.mask.replace([0-9]g, '_'))) {
								...
								var splittedHours   = +([$(this).val()[0], $(this).val()[1]].join('')),
								 ...
								 parse the numbers as 0312 = 0312
				...
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						while (i  _xdsoft_datetime.currentTime.countDaysInMonth()  start.getDay() !== options.dayOfWeekStart  _xdsoft_datetime.currentTime.getMonth() === start.getMonth()) {
							...
							} else if(options.allowDates && options.allowDates.length0){
			...
			input
				...
				.on('keydown.xdsoft', function (event) {
					...
					if ([ENTER].indexOf(key) !== -1 && options.enterLikeTab) {
						elementSelector = $(inputvisible,textareavisible,buttonvisible,avisible);
						datetimepicker.trigger('close.xdsoft');
